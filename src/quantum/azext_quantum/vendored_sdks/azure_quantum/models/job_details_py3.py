...
class JobDetails(Model):
    ...
    :ivar begin_execution_time: The time when the job began executing
    :vartype begin_execution_time: str
    :ivar end_execution_time: The time when the job finished executing
    ...
    :ivar error_data: The error data for the job. This is expected if Status
    ...
    def __init__(self, *, container_uri: str, input_data_format: str, provider_id: str, target: str, id: str=None, input_data_uri: str=None, input_params=None, metadata=None, output_data_format: str=None, **kwargs) -> None:
