...
class JobOperations:
    ...
    async def _create_or_update_initial(
        ...
        account_name: str,
        job_name: str,
        placement_policies: List["models.PlacementPolicy"],
        framework_image: "models.FrameworkImageBase",
        ...
        scheduling_priority: Optional[Union[str, "models.SchedulingPriority"]] = None,
        data_location: Optional[List["models.StorageLocation"]] = None,
        code_location: Optional["models.StorageLocation"] = None,
        output_location: Optional["models.StorageLocation"] = None,
        group_policy_name: Optional[str] = None,
        checkpoint_policy: Optional["models.CheckpointPolicy"] = None,
        compilation_policy: Optional["models.CompilationPolicy"] = None,
        deployment_policy: Optional["models.DeploymentPolicy"] = None,
        ...
        **kwargs
    ) -> Optional["models.JobResourceDescription"]:
    ...
    async def begin_create_or_update(
        ...
        description: Optional[str] = None,
        **kwargs
    ) -> AsyncLROPoller["models.JobResourceDescription"]:
        ...
        :return: An instance of AsyncLROPoller that returns either JobResourceDescription or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~ai_supercomputer_management_client.models.JobResourceDescription]
    ...
    async def _create_sas_token_initial(
        self,
        resource_group_name: str,
        account_name: str,
        job_name: str,
        ...
        protocol: Optional[Union[str, "models.ProtocolType"]] = None,
        group_policy_name: Optional[str] = None,
        **kwargs
    ) -> "models.JobSasTokenDescription":
    ...
    async def begin_create_sas_token(
        self,
        resource_group_name: str,
        account_name: str,
        job_name: str,
        ...
        group_policy_name: Optional[str] = None,
        **kwargs
    ) -> AsyncLROPoller["models.JobSasTokenDescription"]:
        ...
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of AsyncLROPoller that returns either JobSasTokenDescription or the result of cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~ai_supercomputer_management_client.models.JobSasTokenDescription]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.JobSasTokenDescription"]
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._create_sas_token_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                job_name=job_name,
    ...
    def list_by_account(
        ...
        account_name: str,
        **kwargs
    ) -> AsyncIterable["models.JobResourceDescriptionList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~ai_supercomputer_management_client.models.JobResourceDescriptionList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def begin_remove(
        ...
        **kwargs
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._remove_initial(
                resource_group_name=resource_group_name,
                account_name=account_name,
                job_name=job_name,
                group_policy_name=group_policy_name,
